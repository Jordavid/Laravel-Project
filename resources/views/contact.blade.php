...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-6 col-xs-offset-3" style="border: 1px dashed white; margin-top: 8px; background: #122b40; border-radius: 10px;">
            <h2 class="text-center" style="color: white; font-weight: 800">Contact us <span class="glyphicon glyphicon-hand-down"></span> </h2>
            ...
            <form action="rec.php" method="POST">
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary btn-block" name="b_reg">Send message</button>
                </div>
            </form>
